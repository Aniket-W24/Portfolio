...
export default function Education(){
    return (
        ...
        <EducationCard title = "BSC(H) Computer Science  (2024)" imgSrc = "/graduation.jpg" body="I graduated with honors in Computer Science from Delhi University, achieving a CGPA of 8.12."/>
